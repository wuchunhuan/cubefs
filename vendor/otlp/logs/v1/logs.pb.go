...
type LogRecord struct {
	...
	TraceId otlp.TraceID `protobuf:"bytes,9,opt,name=trace_id,json=traceId,proto3,customtype=go.opentelemetry.io/collector/model/internal/data.TraceID" json:"trace_id"`
	// A unique identifier for a span within a trace, assigned when the span
	// is created. The ID is an 8-byte array. An ID with all zeroes is considered
	// invalid. Can be set for logs that are part of a particular processing span.
	// If span_id is present trace_id SHOULD be also present. [Optional].
	SpanId otlp.SpanID `protobuf:"bytes,10,opt,name=span_id,json=spanId,proto3,customtype=go.opentelemetry.io/collector/model/internal/data.SpanID" json:"span_id"`
	// The trace_id is a string. this is a new field because of some historical problems
	TraceIdStr string `protobuf:"bytes,11,opt,name=trace_id_str,json=traceIdStr,proto3" json:"trace_id_str,omitempty"`
	// The span_id is an string. this is a new field because of some historical problems
	SpanIdStr string `protobuf:"bytes,12,opt,name=span_id_str,json=spanIdStr,proto3" json:"span_id_str,omitempty"`
}
...
func (m *LogRecord) GetTraceIdStr() string {
	if m != nil {
		return m.TraceIdStr
	}
	return ""
...
func (m *LogRecord) GetSpanIdStr() string {
	if m != nil {
		return m.SpanIdStr
	}
	return ""
